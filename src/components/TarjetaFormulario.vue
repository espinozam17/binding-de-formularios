  ...
  <div id="app">
    <form>
      ...
      <div>
        ...
        <input v-model="fechaExpiracion" type="date" />
      </div>
      ...
      <div>
        ...
        <select v-model="tipoTarjetaSrc" class="form-select" aria-label="Default select example">
          <option selected disabled>Selecciona una opción</option>
    ...
    <div class="carnet">
      ...
      <div>
        ...
        <span>Fecha Exp: <b>{{ formatoFecha(fechaExpiracion) }}</b></span>
      </div>
      <footer>
